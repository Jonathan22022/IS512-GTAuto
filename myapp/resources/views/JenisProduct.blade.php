...
<head>
    ...
    <title>Jenis Product</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gradient-to-b from-white-300 to-red min-h-screen font-sans">
    <!-- Sidebar -->
    ...
    <!--Melakukan sort dari collection products, untuk yang browse parts terdiri dari Engine,Intake,Forced induction,Exhaust,Drivetrain,Handling. Untuk yang Browse Cosmetics Parts, terdiri dari Bodykits, Wheels, Livery and Wraps, Aerodynamics, Racing Gear'-->
    <div>
        <div>
            <div>
                <h2 class="text-white">Browse Parts</h2>
            </div>
            <div>
                <img src="{{ asset('Gambar Product/ae.png') }}" class="h-10">
            </div>
        </div>
        <div>
            <div>
                <h2 class="text-white">Browse Cosmetics Parts</h2>
            </div>
            <div>
                <img src="{{ asset('Gambar Product/af.png') }}" class="h-10">
            </div>
        </div>
    </div>
    <script>
